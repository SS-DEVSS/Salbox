...
const AboutUs = () => {
  return (
    <main className="bg-scarlet-400 flex flex-col text-center p-6 lg:max-h-[800px] lg:flex-row lg:gap-10 lg:text-start lg:p-14 lg:pr-0">
      <section className="xl:basis-1/2 flex flex-col justify-center">
        ...
        <p className="text-center mb-5 md:text-justify leading-8 text-white">
          En Salbox, nos dedicamos a preparar comida saludable y accesible para
          todos. Empezamos como un local con Drive-Thru y entregas a domicilio,
          pero nuestro objetivo es convertirnos en una empresa de logística
          alimentaria.
        </p>
        <AboutUsCard
          img={MissionIcon}
