...
export function AppPromotion() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center md:gap-16 px-6 xl:px-20 2xl:px-40 overflow-hidden md:max-h-[900px]">
      <ContainerScroll
        titleComponent={
          <div className="md:hidden">
            <h2 className="text-4xl uppercase font-semibold text-scarlet-400 dark:text-white">
              ¡Proximamente! <br />
            </h2>
